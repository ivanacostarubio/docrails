h2. A Guide to Active Record Inheritance

This guide covers the single table inheritance features of Active Record. By referring to this guide, you'll be able to: 

* Configure your database to use Single Table Inheritance
* Take advantage of Single Table Inheritance in Active Record

Please note we'll be referring to Single Table Inheritance as STI

h3. Why Single Table Inheritance?
...
Imagine you are working on a project were you have Students and Professors and Parents. They all will be using your rails app. Therefore, you model the domain like: 
